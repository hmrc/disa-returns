...
class ReturnsSummaryService @Inject() (
  ...
  def saveReturnsSummary(zRef: String, year: Int, month: Int, totalRecords: Int): Future[SaveReturnsSummaryResult] =
    metadataRepo.existsForZrefAndPeriod(zRef, year, month).flatMap {
